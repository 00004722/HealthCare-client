...
function App() {
  ...
  return (
    <BrowserRouter>
      {isLoggedIn ? <BarraNav /> : <Navbarinit />}
      <Routes>
        <Route path="/" element={<Homepage />} />
        <Route path="/Register" element={<Ingresar setIsLoggedIn={setIsLoggedIn} />} />
        <Route path="/Login" element={<InicioSesion setIsLoggedIn={setIsLoggedIn} />} />
